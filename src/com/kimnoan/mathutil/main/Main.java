 ...
 */
package com.kimnoan.mathutil.main;

import com.kimnoan.mathutil.core.MathUtil;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This jar file is build an based on ANT co-operating with Junit");
      tryTDDFirst();
